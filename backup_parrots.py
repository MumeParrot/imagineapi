...
PROMPTS = [
    ...
    "cute, loudly squaking silly parrot character, roughly drawn, wearing a party hat while celebrating a stock market win, simple background, circular png",
    ...
    "cute, loudly squaking silly parrot character, roughly drawn, wearing a tiny wizard hat, casting magic over stock graphs, simple background, circular png",
